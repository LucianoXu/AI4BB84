...
- 🟢 [holevo-chi](holevo-chi.md) — `χ(e) := Sᵥₙ(mix e) − Σᵢ pᵢ Sᵥₙ(ρᵢ)` defined; trivial-ensemble fact proved; `cqState` defined in `AI4BB84/Information/CQState.lean`; marginal lemmas + nonnegativity + Holevo bound queued. 2026-05-08.
